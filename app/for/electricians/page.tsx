...
export default function ElectriciansPage() {
  return (
    <>
      <StructuredData data={buildBreadcrumbSchema([{ name: "Home", path: "/" }, { name: "For electricians", path: "/for/electricians" }])} />
      <StructuredData data={buildServiceSchema({ name: content.title, description: content.summary, path: "/for/electricians" })} />
