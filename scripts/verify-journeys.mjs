...
const criticalRouteExpectations = {
  ...
  "/examples": ["After setup is reviewed", "Appointment booked with owner visibility", "Booking request pending owner confirmation", "Service-area review callback", "Urgent owner alert", "Owner summary"],
