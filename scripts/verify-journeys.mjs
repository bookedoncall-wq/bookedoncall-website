...
const criticalRouteExpectations = {
  ...
  "/examples": ["After setup is reviewed", "Emergency owner alert after hours", "Appointment booked from reviewed rules", "Owner-review estimate request", "Measure request pending owner confirmation", "Service-area review callback", "Small-job triage callback", "Owner summary"],
