...
export async function GET() {
  ...
  const lines = [
    ...
    `- Demo calls: ${siteConfig.url}/demo-calls`,
    ...
    `- Ready-to-connect integrations: ${configurableIntegrations.join(", ")}`,
    `- Planned integrations: ${roadmapIntegrations.join(", ") || "None listed"}`,
