      ...
      <section className="bg-white px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-5xl gap-4 md:grid-cols-3">
          ...
          >
            ...
            <p className="text-base leading-7 text-slate-600">Use the live web voice demo when it is available, then review example calls before deciding how summaries should reach your inbox.</p>
          </TrackedLink>
          <TrackedLink
            href="/pricing"
            eventName="marketing_cta_clicked"
