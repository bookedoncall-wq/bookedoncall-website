      ...
      <section className="bg-slate-50 px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-8">
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
            ...
            <p className="text-lg leading-8 text-slate-600">
              BookedOnCall is built to fit your current workflow. That includes Jobber, Google Calendar, and customer Text / SMS follow-up after those workflows are configured for your business. If your shop uses Housecall Pro or ServiceTitan, request a compatibility review so we can map the safest handoff.
            </p>
            </div>
            <TrackedLink
              href="/integrations"
