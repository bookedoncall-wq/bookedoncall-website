...
const criticalRouteExpectations = {
  ...
  "/for/plumbers": ["AI call answering for plumbing businesses", "Common calls in this trade", "Book when it fits"],
  "/for/hvac": ["AI call answering for HVAC companies", "Common calls in this trade", "Book when it fits"],
  "/for/electricians": ["AI call answering for electrical contractors", "Common calls in this trade", "Book when it fits"],
  "/for/painters": ["AI call answering for painting businesses", "Common calls in this trade", "Book when it fits"],
  "/for/flooring": ["AI call answering for flooring contractors", "Common calls in this trade", "Book when it fits"],
  "/for/landscaping": ["AI call answering for landscaping businesses", "Common calls in this trade", "Book when it fits"],
  ...
  "/compare/after-hours-call-answering-for-hvac": ["After-hours call answering for HVAC", "After-hours HVAC calls are usually high-pressure", "Read sample calls"],
  "/compare/after-hours-call-answering-for-plumbers": ["After-hours call answering for plumbers", "What happens after hours", "Read sample calls"],
  ...
  "/faq": ["Questions worth answering before you pay", "Does BookedOnCall always book appointments automatically"],
  "/about": ["Why we built BookedOnCall", "The founder", "No trades business should lose a good job"],
  "/privacy": ["Privacy Policy", "Calls may involve AI and recording", "Customers remain responsible for notices"],
  "/terms": ["Terms of Service", "Owners control the business rules", "Roadmap, beta, and examples"],
  "/call-handling-notice": ["Call Handling Notice", "Callers may speak with an assistant", "Not for emergencies"],
  "/sms-terms": ["SMS Terms", "Consent matters", "You can opt out"],
  "/dpa": ["Data Processing Addendum", "Customer instructions control", "Subprocessors support operations"],
